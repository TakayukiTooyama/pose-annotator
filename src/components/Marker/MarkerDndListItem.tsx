...
type Props = {
  ...
  deleteMarkerOption: (marker: MarkerOption) => void;
  updateMarkerColor: (color: string, marker: MarkerOption) => void;
};

export const MarkerDndListItem: FC<Props> = memo(
  ({ marker, markers, deleteMarkerOption, updateMarkerColor }) => {
    const {
      isEdit,
      errorMessage,
      label,
